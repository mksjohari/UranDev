		...
		<div ref={node} className={styles.logout}>
			<div className={styles.logout_btn}  onClick={() => setOpen(!open)}>
				<div className={styles.crop}>
					<img className={styles.profile_pic} src={user.photoUrl} alt="profile" />
				</div>
			...
			>
				...
				onClick={()=>{goProfile(user, history)}}>
				...
				<p className={styles.option} 
				onClick={()=>{logout(props.logoutUser, history)}}>

...
function SkillToolProgress(props) {
    const colour = {skill: ["#fad47a", "#FAEBB3"], tool: ["#3E4D74", "#AFDEE9"]}
    return (
        <div className={styles.progress_section}>
                ...
                <div className={styles.progress_bar}>
                    ...
                    <ProgressBar
                        width={window.innerWidth < 992 ? props.dims.width * 0.4 : props.dims.width * 0.15}
                        height="10px"
                        filledBackground={
                            props.item.value < 10 ? colour[props.type][1] : colour[props.type][0]
                        }
                        percent={props.item.value * 10 < 100 ? props.item.value * 10 : 100}
                    />
                </div>
        </div>
    );
